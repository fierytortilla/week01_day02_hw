...
class FunctionsTest < MiniTest::Test
  ...
  def test_volume_of_cube()
    cube_volume= calculate_cube_volume(4.0)
    assert_equal(64.0, cube_volume)
  end

  #Given the radius of a sphere calculate the volume
  def test_volume_of_sphere()
    sphere_volume= calculate_sphere_volume(6.0)
    assert_equal(904.7787, sphere_volume)
  end

  #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius()
    celsius= convert_fahrenheit_to_celsius(70)
    assert_equal(21.1111, celsius)
  end
